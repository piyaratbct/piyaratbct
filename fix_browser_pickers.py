...
if target1 in content:
    ...
    print("Target 1 not found in LessonLogForm.tsx")
...
if target2 in content:
    ...
    print("Target 2 not found in LessonPlanForm.tsx")
...
replacement3 = """                  <div className="flex gap-2">
...
if target3 in content:
    ...
    print("Target 3 not found in DisciplineModule.tsx")
