...
// replace the button labels back
...
content = content.replace('{activeTab === "special-care" && (() => {', '{activeTab === "health" && (() => {');

// For the second part, just include it into the same condition
content = content.replace('})()}\n\n{activeTab === "health-report" && (() => {', '  {/* Health Report Part */}\n  ');

// Fix closing
content = content.replace('      </div>\n    </div>\n  );\n})()}\n      </div>\n\n      {/* Assessment Modal/Form Overlay */}', '      </div>\n    </div>\n  );\n})()}\n      </div>\n\n      {/* Assessment Modal/Form Overlay */}');
